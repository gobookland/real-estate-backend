let Sector,ApolloError;_d44‍.x([["sectors",()=>sectors],["addSector",()=>addSector],["deleteSector",()=>deleteSector]]);_d44‍.w("../../models/Sector",[["default",["Sector"],function(v){Sector=v}]]);_d44‍.w("apollo-server",[["ApolloError",["ApolloError"],function(v){ApolloError=v}]]);
...
// Delete sector with name, type
       const deleteSector = async (_, { type, parent, name }) => {
	try {
